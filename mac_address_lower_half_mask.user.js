// ==UserScript==
// @name         MAC Address Lower Half Mask
...
(function() {
    ...
    for(var i=0; i<txt.snapshotLength; i++) {
        ...
        var newText = txt.snapshotItem(i).nodeValue.replace(/([0-9a-fA-F]{2})[.\-:]?([0-9a-fA-F]{2})[.\-:]([0-9a-fA-F]{2})[.\-:]?([0-9a-fA-F]{2})[.\-:]([0-9a-fA-F]{2})[.\-:]?([0-9a-fA-F]{2})/gi, ' $1:$2:$3:**:**:**');
